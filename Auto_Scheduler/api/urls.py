...
from Auto_Scheduler.api.views import LanguageView, updateLanguage,DayView,TimeView,Time_DayView,Delete_Room,Delete_Time_Day,Room_View, professor_view,CoursesView
